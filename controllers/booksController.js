...
exports.deleteBook = exports.updateBook = exports.getBookById = exports.getBooks = void 0;
...
var getBookById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, books_1.Book.findByPk(req.params.id)];
            case 1:
                book = _a.sent();
                if (book) {
                    res.json(book);
            ...
            case 2:
                error_2 = _a.sent();
                console.error("Error fetching book by ID:", error_2);
                res.status(500).json({ error: "Internal server error" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
...
var updateBook = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var updatedBookCount, updatedBook, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, books_1.Book.update(req.body, {
                        where: { id: req.params.id },
                    })];
            case 1:
                updatedBookCount = (_a.sent())[0];
                if (!(updatedBookCount > 0)) return [3 /*break*/, 3];
                return [4 /*yield*/, books_1.Book.findByPk(req.params.id)];
            case 2:
                updatedBook = _a.sent();
...
var deleteBook = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var deletedBookCount, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, books_1.Book.destroy({
                        where: { id: req.params.id },
                    })];
            case 1:
                deletedBookCount = _a.sent();
